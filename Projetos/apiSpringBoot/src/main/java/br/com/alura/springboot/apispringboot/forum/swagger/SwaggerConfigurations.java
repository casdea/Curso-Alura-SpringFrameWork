package br.com.alura.springboot.apispringboot.forum.swagger;
...
public class SwaggerConfigurations {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.alura.springboot.apispringboot.forum")).paths(PathSelectors.ant("/**")).build()
